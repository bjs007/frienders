...
//        commandParams[25] = outputPath;
        ...
        compressVideo(command, outputPath, listener);
...
//                    Toast.makeText(context, " ffpage not supported", Toast.LENGTH_SHORT).show();
//                }
//            });
//           fmpeg.execute(command, new FFmpegExecuteResponseHandler() {
//                @Override
...
//
//                        String s = "Output video path : " + outputFilePath + "\n" +
...
//            });
            ...
            int rc = FFmpeg.execute("-i " + command[0] + " -c:v mpeg4 " + outputFilePath);
